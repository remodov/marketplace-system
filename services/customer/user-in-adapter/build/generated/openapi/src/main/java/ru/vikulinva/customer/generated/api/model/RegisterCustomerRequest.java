...
public class RegisterCustomerRequest {
   ...
   */
  public RegisterCustomerRequest(String email, String firstName, String lastName) {
    this.email = email;
    this.firstName = firstName;
    this.lastName = lastName;
  }

  public RegisterCustomerRequest email(String email) {
    this.email = email;
    return this;
  }
   ...
   * @return email
   */
  @NotNull @Size(min = 3, max = 254) @jakarta.validation.constraints.Email 
  @JsonProperty("email")
  ...
  public RegisterCustomerRequest firstName(String firstName) {
    this.firstName = firstName;
    return this;
  }
  ...
  public RegisterCustomerRequest lastName(String lastName) {
    this.lastName = lastName;
    return this;
  }
  ...
  public RegisterCustomerRequest phone(String phone) {
    this.phone = phone;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.email, registerCustomerRequest.email) &&
        ...
        Objects.equals(this.phone, registerCustomerRequest.phone);
  }
